...
export function PlaylistView() {
  ...
  return (
    <section className="flex-1  bg-gradient-to-b from-[#9E2984] via-[#421237] to-[#121212] rounded-sm text-white h-full overflow-y-auto">
      {/* Header */}
      <div className="border-b-2 border-t-2 mt-[1px] shadow-xl border-neutral-900/70">
      ...
      <div className="p-3">
        {/* Controls */}
        <div className="p-2 mt-6 flex items-center gap-6">
          <Button
        ...
        <div className="px-6 mt-4">
          <table className="w-full border-collapse">
            <thead>
              <tr className="text-zinc-400 text-sm border-b border-neutral-500/40">
